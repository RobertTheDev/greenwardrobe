...
export default function ShopLegalPage() {
  return (
    <section>
      <div
        className="w-full bg-cover bg-center bg-no-repeat px-12 pb-14 pt-28 lg:pb-24 lg:pt-44 xl:px-20"
        style={{ backgroundImage: "url('/images/legal/hero.png')" }}
      >
        <h1 className="font-manrope mb-8 text-center text-3xl font-bold leading-tight text-gray-900 lg:text-5xl">
          Terms of Use
        </h1>
        <p className="px-4 text-center text-lg font-normal leading-8 text-gray-900">
          ...
          <div className="flex w-full flex-col gap-8 md:flex-row">
            <div className="w-full md:max-w-[176px] md:border-r md:border-gray-200">
              <ul className="tab-nav flex flex-col items-center gap-6 md:items-start lg:gap-10">
                <li>
                  <a
                    href="/"
                    className="text-base font-medium leading-7 text-indigo-600"
                  >
                    Terms of Use
                  </a>
                </li>
                <li>
                  <a
                    href="/"
                    className="text-base font-medium leading-7 text-gray-500 hover:text-indigo-600"
                  >
                    Privacy Policy
                  </a>
                </li>
            ...
            <div className="tab-pane w-full max-md:px-4">
              ...
              <p className="mb-8 text-lg font-normal leading-8 text-gray-500 lg:mb-10">
                ...
                digital content and/or services to you, how you and we may
                change or end the contract, what do in the event of a problem
              ...
              <ul className="mb-8 ml-8 lg:mb-10">
                ...
                <li className="list-decimal text-lg font-normal text-gray-500">
                  <a href="/">
                    There Is No Fee to Pagedone for Finding EngagementsThere Is
                    No Fee to Pagedone for Finding Engagements
                  </a>
                </li>
                <li className="list-decimal text-lg font-normal text-gray-500">
              ...
              <ul className="font-manrope ml-8 flex list-outside list-decimal flex-col gap-10 text-3xl font-bold">
                <li id="01" className="list-decimal">
                  ...
                  <p className="mt-5 text-lg font-normal leading-8 text-gray-500">
                    ...
                    user is referred to generally for purposes of these Terms as
                    a Client User). BY USING THE SITE, AND/OR BY REGISTERING
                    WITH US, YOU AGREE TO THESE TERMS OF USE, You consent to the
                    information practices disclosed in our Privacy Policy and
                    our Cookies Policy which are incorporated herein by
                    reference, and that you consent to resolve in the State of
                    New York pursuant to the terms set forth herein any dispute
                    that you may have with us, or the Site. Please note that we
                    offer the Site AS IS and without warranties. If you are
                    registering an account or using the Site on behalf of an
                    individual or entity other than yourself, you represent that
                    you are authorized by such individual or entity to accept
                ...
                <li id="02" className="list-decimal">
                  ...
                  <p className="mt-5 text-lg font-normal leading-8 text-gray-500">
                    ...
                    authorize the use and disclosure of your personal and legal
                    information pursuant to the terms of our Privacy Policy for
                    purposes of allowing us to provide the Services and as
                    otherwise disclosed in our Privacy Policy available at
                    ...
                    seeking legal services. Pagedone itself does not provide
                    legal advice and does not provide legal services of any
                    nature whatsoever. And Pagedone does not guarantee that
                    Client Users will find legal representation through its
                    system. Pagedone offers no opinion nor does it take a
                    ...
                    ensure the completion of agreements between the Client User
                    and Attorney User, the accuracy or completeness of the
                    work-product of the Attorney User, or the integrity of
                    either party. The Client User is responsible for evaluating
                    the integrity and abilities of all Attorney Users with whom
                    the Client User communicates using the Site. You acknowledge
                    that although some of the content, text, data, graphics,
                    images, information, suggestions, guidance, and other
                    material (collectively, Information) that is provided to you
                    on the Site (including Information provided in direct
                    ...
                    professional. Any form of use of the Site by potential
                    clients or subscribing Attorney Users is not intended to and
                    will not create an attorney-client relationship between or
                    among any person, entity, and Pagedone. Any electronic
                    communication sent to anyone at Pagedone other than an
                    Attorney User will not create an attorney-client
                    relationship between the Client User and Pagedone.
                  </p>
                </li>
                <li id="03" className="list-decimal">
                  ...
                  <p className="mt-5 text-lg font-normal leading-8 text-gray-500">
                    ...
                    design advice, recommendations, consultations or any kind of
                    counseling. Pagedone makes its Designers available to you
                    and any information provided to you by Pagedone (other than
                    through a Designer that you hire to work with you) is (i)
                    provided by independent design professionals and
