      ...
      <div className="mx-auto flex w-full max-w-screen-xl">
        <div className="flex w-full flex-wrap items-center gap-4 lg:gap-y-2">
          ...
          <div className="ml-auto flex items-center gap-x-6 gap-y-4">
            <div className="flex max-w-52 overflow-hidden rounded-full border border-black bg-gray-50 px-4 py-2.5 focus-within:border-gray-400 focus-within:bg-transparent max-lg:hidden">
              <input
                type="text"
            ...
            <div className="flex items-center space-x-6 sm:space-x-8">
              ...
              <button className="flex cursor-pointer flex-col items-center justify-center gap-0.5">
